...
YOLO_PATH = r"E:\dev\projekt_python_venv\010_Riffbarsch\models\yolov8n\riffbarsch_taucher_run\best.pt"
...
def run_classification(img):
    ...
    # Balkendiagramm
    fig, ax = plt.subplots(figsize=(4,3))
    ax.bar(class_names, probs, color=['orange','blue'])
    ax.set_ylim(0,1)
